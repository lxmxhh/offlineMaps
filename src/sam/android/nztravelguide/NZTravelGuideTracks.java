...
import sam.android.nztravelguide.maps.NavControls;
...
public class NZTravelGuideTracks extends TabActivity implements OnTouchListener {	
	...
	public boolean onTouch(View v, MotionEvent event) {
		if (NZTravelGuide.isGPSTracking == true) {
