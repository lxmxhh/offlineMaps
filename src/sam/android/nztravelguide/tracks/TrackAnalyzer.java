...
//		maxAltitude = 0d;
	...
	public void analyzeAndUpdate(long trackID) {
		...
		NZTravelGuide.DBAdapter.updateTrack(trackID, totalTime, totalDistance, 
	...
	public void analyzeAndSave() {
		...
		NZTravelGuide.DBAdapter.open();
		long trackID = NZTravelGuide.DBAdapter.insertTrack(trackName, trackDescription, startGMTTime, locationList, trackSource);
